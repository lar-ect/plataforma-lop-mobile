 ...
 */
public class Cadastrar extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMatriculaView = (EditText) findViewById(R.id.matricula);
    ...
    private void attemptLogin() {
        ...
        Log.i("String1",password);
        Log.i("String2",password2);
        Log.i("Status"," " + TextUtils.equals(password,password2));
        if(!TextUtils.equals(password,password2)){
            mPasswordView.setError("As senhas não são iguais");
            mPassword2View.setError("As senhas não são iguais");
            focusView = mPasswordView;
            cancel = true;
        }
        ...
        if (cancel) {
            ...
            final StringRequest jsonObjRequest = new StringRequest(Request.Method.POST,
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                boolean status = jObj.getBoolean("status");
                                if(status){
                                    /*Intent intent = new Intent(getApplicationContext(),EmailEnviado.class);
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    Map<String, String> params = new HashMap<String, String>();
                    params.put("nome",mNomeView.getText().toString());
                    params.put("email", mEmailView.getText().toString());
                    params.put("matricula",mMatriculaView.getText().toString());
                    params.put("password",mPasswordView.getText().toString());
                    params.put("password-confirm",mPassword2View.getText().toString());
                    return params;
                }
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(Cadastrar.this,
