...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private TextView tCadastro;
    private TextView tRecuperar;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tCadastro = (TextView) findViewById(R.id.cadastro);
        tRecuperar = (TextView) findViewById(R.id.recuperarSenha);
        tCadastro.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(),Cadastrar.class));
            }
        });
        tRecuperar.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
